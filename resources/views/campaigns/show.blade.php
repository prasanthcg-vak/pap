                                            ...
                                            <span>
                                                <div class="action-btn-icons ">
                                                    ...
                                                    <a href="#" class="edit-task-btn" data-id="{{ $task->id }}"
                                                        ...
                                                        <span>Edit Task</span> <i class="fa-solid fa-pen"></i>
                                                    </a>
                                                    @if ($deleteButton)
                                                        <form id="Model-Form"
...
@section('script')
    ...
    $.ajax({
        ...
        success: function (response) {
            $('#modalLoader').hide();
            alert(response.task.category_id);           
            // Populate the modal with data
            modal.find('#campaign-select').val(response.task.campaign_id);
            modal.find('#client-name').val(response.task.client_name); // Assuming it’s editable
