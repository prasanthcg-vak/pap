                                                        ...
                                                        <div class="media">
                                                            ...
                                                            <div class="media-body">
                                                                ...
                                                                <p>{{ $comment->content }} <button
                                                                        class="btn btn-danger btn-sm delete-reply m-2"
                                                                ...
                                                                <form class="replyForm mt-2 d-flex" method="POST">
                                                                    ...
                                                                    <div class="comments-button">
                                                                        <button type="submit" class="comments-btn"><i
                            ...
                            <div class="col-xl-4">
                                ...
                                <div class="input-wrap">
                                    <input type="text" name="date_required" id="datepicker" required
                                        placeholder="Date Required" value="{{ $task->date_required }}">
                            ...
                            <div class="col-lg-6 col-xl-3 p-xl-0">
                                <div class="input-wrap">
                                    <input type="text" name="size_width" id="size_width" required
                                        placeholder="Size (Width)" value="{{ $task->size_width }}">
                                    <input type="text" name="size_height" id="size_height" required
                                        placeholder="Size (Height)" value="{{ $task->size_height }}">
                                </div>
                            </div>
                        </div>
                        <div class="row m-0">
