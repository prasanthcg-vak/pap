...
@section('content')
    @php
        $store = Auth::user()->hasRolePermission('asset-types.store');
        $edit = Auth::user()->hasRolePermission('asset-types.update');
        $delete = Auth::user()->hasRolePermission('asset-types.destroy');
    @endphp
                                ...
                                <td>
                                    @if ($edit)
                                        <a href="#" class="btn search"
                                            onclick="editAssetType({{ json_encode($assetType) }})">
    ...
    <!-- Modal -->
    <div class="modal fade modal-margin" id="assetTypeModal" tabindex="-1" role="dialog"
                    ...
                    <form id="assetTypeForm">
                        ...
                        <div class="row m-0">
                            ...
                            <div class="col-lg-12">
                                ...
                                <input type="text" name="type_name" id="type_name" class="form-control  common-input"
                                    required>
                            </div>
                            <div class="col-lg-12">
