                                                ...
                                                @foreach ($assetsCollection as $image)
                                                    ...
                                                    <div class="list-item-task">
                                                        ...
                                                        <div class="list-item-con">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <form action="{{ route('shared-assets.save') }}"
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-12">
                                                                                <p class="profile-label">Share with Partners
                                                                                </p>
                                                                            </div>
                                                                            {{-- {{dd($image);}} --}}
                                                                            <div class="col-12">
                                                            ...
                                                            {{-- <div
                                                                class="sic-action-btns d-flex justify-content-end flex-wrap">
                                                                <div class="sic-btn">
